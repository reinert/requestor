...
/**
 * A {@link com.google.gwt.http.client.Response} implementation based on a {@link com.google.gwt.xhr.client.XMLHttpRequest}.
 */
class ResponseImpl extends Response {
  ...
  public JavaScriptObject getData() {
    return xmlHttpRequest.getResponse();
  }

  @Override
  public String getType() {
    return xmlHttpRequest.getResponseType();
  }
