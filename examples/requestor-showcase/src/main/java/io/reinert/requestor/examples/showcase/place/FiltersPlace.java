...
import io.reinert.requestor.examples.showcase.activity.FiltersActivity;

public class FiltersPlace extends Place implements HasActivity, HasToken {

    public static FiltersPlace INSTANCE = new FiltersPlace();

    @Override
    public Activity getActivity() {
        return new FiltersActivity(Showcase.SHOWCASE_CLIENT_FACTORY.getFilters(),
                Showcase.SHOWCASE_CLIENT_FACTORY.getRequestor());
    }

    @Override
    public String getToken() {
        return MenuOption.Tokens.FILTERS_TOKEN;
    }
}
