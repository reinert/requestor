...
public class Serialization extends Composite {
    ...
    @UiField PreElement overlaysSetup, autobeansSetup, gwtjacksonSetup, mySerializer;
//    @UiField TextAreaElement requestFilterTextArea, responseFilterTextArea, responseFilterTextArea2;
    ...
    public Serialization() {
        ...
        HighlightJs.highlightBlock(overlaysSetup, autobeansSetup, gwtjacksonSetup, mySerializer);
    }
