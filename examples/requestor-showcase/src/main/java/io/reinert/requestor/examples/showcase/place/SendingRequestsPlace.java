...
public class SendingRequestsPlace extends Place implements HasActivity, HasToken {

    public static SendingRequestsPlace INSTANCE = new SendingRequestsPlace();

    @Override
    public Activity getActivity() {
        return new SendingRequestsActivity(Showcase.SHOWCASE_CLIENT_FACTORY.getSendingRequests(),
                Showcase.SHOWCASE_CLIENT_FACTORY.getRequestor());
    }

    @Override
    public String getToken() {
        return MenuOption.Tokens.SENDING_REQUESTS_TOKEN;
    }
}
