...
public interface MutableRequest extends Request {
    ...
    /**
     * Input a payload to be sent in the HTTP request body.
     *
    ...
    /**
     * Retrieve the output stream of the request.
     *
     * @return The output stream of the request
     */
    OutputStream getOutputStream();

    /**
     * Replaces the output stream of the request by another.
     *
     * The new output stream must wrap the existing one, retrieved by #getOutputStream.
     *
     * @param outputStream The new output stream of the request
     */
