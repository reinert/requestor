...
/**
 * A simple wrapper around a homogeneous native array of byte values.
 *
 * This class may not be directly instantiated, and can only be returned from a
 * native method. For example,
 *
 * <code>
 * native JsArrayByte getNativeArray() /*-{
 *   return [1, 2, 3];
 * }-* /;
 * </code>
 */
class JsArrayByte extends JavaScriptObject {

    protected JsArrayByte() {
    }
    ...
    /**
     * Pushes the given byte onto the end of the array.
     */
    public final native void push(byte value) /*-{
    ...
    public final native JsArrayByte slice() /*-{
        return this.slice();
    }-*/;
}
