...
abstract class BaseNCodec {
    ...
    private static int compareUnsigned(final int x, final int y) {
        return intCompare(x + Integer.MIN_VALUE, y + Integer.MIN_VALUE);
    }
    ...
    protected BaseNCodec(final int unencodedBlockSize, final int encodedBlockSize,
        ...
        this.pad = pad;
        this.decodingPolicy = requireNonNull(decodingPolicy, "codecPolicy");
    }
    ...
    protected static <T> T requireNonNull(T obj, String message) {
        if (obj == null)
