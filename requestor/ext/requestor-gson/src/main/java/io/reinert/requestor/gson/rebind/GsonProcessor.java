...
public class GsonProcessor extends AbstractProcessor {
    ...
    private final Map<TypeInfo, SerializerGenerator> serializerGenerators =
            new HashMap<TypeInfo, SerializerGenerator>();
    ...
    public Set<String> getSupportedAnnotationTypes() {
        return new LinkedHashSet<String>(Collections.singletonList(GsonSerializationModule.class.getCanonicalName()));
    }
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        try {
            for (Element annotatedElement : roundEnv.getElementsAnnotatedWith(GsonSerializationModule.class)) {
